      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'grid', gap: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <label style={{ color: guaranteedTextColor, marginBottom: '0.5rem' }}>Nombre del Equipo (Opcional)</label>
            <input 
              {...register("listName", { maxLength: { value: 50, message: 'El nombre no puede exceder 50 caracteres.' } })} 
            ...
            />
            {errors.listName && <p style={{ color: 'red', marginTop: '0.5rem' }}>{errors.listName.message}</p>}
          </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.5rem' }}>
                {pokemonOptions.map((pokemon) => (
                    ...
                    >
                        ...
                        <span style={{marginLeft: '0.2rem', textTransform: 'capitalize', color: guaranteedTextColor }}>{pokemon.name}</span>
                    </label>
                ))}
            </div>
            {errors.favorites && <p style={{ color: 'red', marginTop: '0.5rem' }}>{errors.favorites.message}</p>}
          </div>
